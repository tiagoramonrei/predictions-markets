import svgPaths from "./svg-5505oo64wo";
...
function Txt() {
  return (
    <div className="basis-0 grow min-h-px min-w-px opacity-40 relative shrink-0" data-name="txt">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[4px] items-center justify-center not-italic pl-0 pr-[23px] py-[12px] relative text-nowrap text-white w-full whitespace-pre">
    ...
    <div className="basis-0 bg-[#242424] grow h-[40px] min-h-px min-w-px relative rounded-[1000px] shrink-0" data-name="valores">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[8px] h-[40px] items-center justify-center px-[32px] py-[14px] relative w-full">
          <p className="font-['DM_Sans:Bold',sans-serif] leading-[1.4] not-italic relative shrink-0 text-[14px] text-nowrap text-white whitespace-pre">+R$10</p>
        </div>
      </div>
    </div>
  );
...
function Valores1() {
  return (
    <div className="basis-0 bg-[#242424] grow h-[40px] min-h-px min-w-px relative rounded-[1000px] shrink-0" data-name="valores">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[8px] h-[40px] items-center justify-center px-[32px] py-[14px] relative w-full">
          <p className="font-['DM_Sans:Bold',sans-serif] leading-[1.4] not-italic relative shrink-0 text-[14px] text-nowrap text-white whitespace-pre">+R$50</p>
        </div>
      </div>
    </div>
  );
...
function Valores2() {
  return (
    <div className="basis-0 bg-[#242424] grow h-[40px] min-h-px min-w-px relative rounded-[1000px] shrink-0" data-name="valores">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[8px] h-[40px] items-center justify-center px-[32px] py-[14px] relative w-full">
          <p className="font-['DM_Sans:Bold',sans-serif] leading-[1.4] not-italic relative shrink-0 text-[14px] text-nowrap text-white whitespace-pre">+R$100</p>
        </div>
      </div>
    </div>
  );
...
function Title() {
  return (
    <div className="content-stretch flex flex-col items-start not-italic relative shrink-0 text-white" data-name="title">
      ...
      <p className="font-['DM_Sans:Bold',sans-serif] leading-[1.4] relative shrink-0 text-[14px] text-nowrap whitespace-pre">R$ 3.400,00</p>
    </div>
  );
}
...
function Txt1() {
  return (
    <div className="content-stretch flex gap-[4px] items-center justify-end relative shrink-0" data-name="txt">
      <IconDepositar />
      <p className="font-['DM_Sans:Bold',sans-serif] leading-none not-italic relative shrink-0 text-[10px] text-nowrap text-white whitespace-pre">Depositar</p>
    </div>
  );
}
...
function BtnDepositar() {
  return (
    <div className="box-border content-stretch flex h-[32px] items-center justify-center px-[16px] py-[10px] relative rounded-[1000px] shrink-0" data-name="btn-depositar">
...
function Tecla() {
  return (
    <div className="bg-[#242424] content-stretch flex h-[38px] items-center justify-center overflow-clip relative rounded-[4.043px] shrink-0 flex-1 basis-0 min-w-0" data-name="tecla">
...
function Tecla10() {
  return (
    <div className="bg-[#242424] content-stretch flex h-[38px] items-center justify-center overflow-clip relative rounded-[4px] shrink-0 flex-1 basis-0 min-w-0" data-name="tecla">
...
function Retorno() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0" data-name="retorno">
      <div className="flex flex-col font-['DM_Sans:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#e3e3e3] text-[10px] text-nowrap">
