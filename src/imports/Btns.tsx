  ...
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="social media">
      <div className="relative shrink-0 size-[36px]" data-name="tiktok">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgTiktok} />
      </div>
      <div className="relative shrink-0 size-[36px]" data-name="kwai">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgKwai} />
      </div>
      <div className="relative shrink-0 size-[36px]" data-name="telegram">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgTelegram} />
      </div>
      <div className="relative shrink-0 size-[36px]" data-name="instagram">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgInstagram} />
      </div>
      <div className="relative shrink-0 size-[36px]" data-name="facebook">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgFacebook} />
      </div>
      <div className="relative shrink-0 size-[36px]" data-name="twitter">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgTwitter} />
      </div>
      <div className="relative shrink-0 size-[36px]" data-name="youtube">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgYoutube} />
      </div>
    </div>
  );
}
...
export default function Btns() {
  return (
    <div className="content-stretch flex flex-col items-center justify-between relative size-full" data-name="btns">
      <SocialMedia />
    </div>
  );
}