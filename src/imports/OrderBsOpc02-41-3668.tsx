import svgPaths from "./svg-eaqkpx6iwv";
...
function Txt() {
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0" data-name="txt">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[4px] items-center justify-center not-italic pl-0 pr-[23px] py-[12px] relative text-[#32a866] text-nowrap w-full whitespace-pre">
          <p className="font-['DM_Sans:Regular',sans-serif] leading-[1.4] relative shrink-0 text-[16px]">R$</p>
          <p className="font-['DM_Sans:Bold',sans-serif] leading-[52px] relative shrink-0 text-[48px]">200</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0" data-name="retorno">
      <div className="flex flex-col font-['DM_Sans:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#e3e3e3] text-[10px] text-nowrap">
        <p className="leading-none whitespace-pre">{`R$200 `}</p>
      </div>
      ...
      <div className="flex flex-col font-['DM_Sans:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#e3e3e3] text-[10px] text-nowrap">
        <p className="leading-none whitespace-pre">R$ 234</p>
      </div>
    </div>
  );
}
...
function Btn() {
  return (
    <div className="bg-[#32a866] h-[48px] relative rounded-[1000px] shrink-0 w-full" data-name="btn">
