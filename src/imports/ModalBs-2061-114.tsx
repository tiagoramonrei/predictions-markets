import svgPaths from "./svg-77jemmjyjz";
...
function Content() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-center not-italic relative shrink-0 text-center w-full" data-name="content">
      <p className="font-['DM_Sans:Bold',sans-serif] leading-[1.4] relative shrink-0 text-[16px] text-nowrap text-white whitespace-pre">O que é Total Ganho?</p>
