import svgPaths from "./svg-wjbrcz9efd";
import imgImagem from "figma:asset/562cec5dc1dde5641c98cbf9e6b84b136f03e611.png";
    ...
    <div className="h-[8px] relative w-[11.142px]" data-name="iconReplace">
      <div className="absolute inset-[-9.37%_-6.73%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13 10">
          <g id="iconReplace">
            <path d={svgPaths.p22485500} id="iconReplace_2" stroke="var(--stroke-0, #D92341)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
            <path d={svgPaths.p339deb40} id="iconReplace_3" stroke="var(--stroke-0, #D92341)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
            <path d={svgPaths.p33faed40} id="iconReplace_4" stroke="var(--stroke-0, #D92341)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
            <path d={svgPaths.p1b4ada80} id="iconReplace_5" stroke="var(--stroke-0, #D92341)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          </g>
        </svg>
      </div>
    </div>
  ...
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="titulo">
      <div className="flex flex-col font-['DM_Sans:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#d92341] text-[14px] text-nowrap">
        <p className="leading-[1.4] whitespace-pre">NÃO</p>
      </div>
...
function Porcentagem() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-end justify-center leading-[0] not-italic relative shrink-0 text-nowrap" data-name="porcentagem">
      <div className="flex flex-col font-['DM_Sans:Bold',sans-serif] justify-center relative shrink-0 text-[16px] text-white">
        <p className="leading-[1.2] text-nowrap whitespace-pre">117,64</p>
      </div>
      <div className="flex flex-col font-['DM_Sans:Regular',sans-serif] justify-center relative shrink-0 text-[#e3e3e3] text-[10px]">
...
function Txt() {
  return (
    <div className="box-border content-stretch flex gap-[4px] items-center justify-center not-italic opacity-40 px-0 py-[12px] relative shrink-0 text-nowrap text-white w-full whitespace-pre" data-name="txt">
...
function Retorno() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-end relative shrink-0 w-full" data-name="retorno">
      <div className="flex flex-col font-['DM_Sans:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-nowrap text-white">
        <p className="leading-none whitespace-pre">117,64 cotas</p>
      </div>
      ...
      <div className="flex flex-col font-['DM_Sans:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-nowrap text-white">
        <p className="leading-none whitespace-pre">R$105,88</p>
      </div>
    </div>
  );
}
...
function Info() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-end relative shrink-0" data-name="info">
      <Retorno />
      <div className="flex flex-col font-['DM_Sans:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-nowrap text-white">
        <p className="leading-none whitespace-pre">Chance atual 90%</p>
      </div>
    </div>
  );
}
